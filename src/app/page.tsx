...
export default async function Home() {
  ...
  return (
    <main className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      <Card className="w-[400px] bg-gray-100 dark:bg-gray-900">
        <CardHeader>
        ...
        <CardContent className="text-center text-sm font-medium text-gray-800 dark:text-gray-200">
          <p>Create engaging quizzes effortlessly with QuizGen, an innovative app powered by OpenAI. Generate dynamic and interactive quizzes for your audience with ease</p>
        </CardContent>
